  ...
  <card-swap>
    ...
    <simple-wrapper-slim-sm>
      <form-group-between>
        <template v-slot:left>
          ...
          >
            <template v-slot:label> Origin </template>
          </search-select>
        </template>
        ...
        <template v-slot:right>
          ...
          >
            <template v-slot:label> Destination </template>
          </search-select>
        </template>
      </form-group-between>
    </simple-wrapper-slim-sm>
    ...
    <template v-slot:footer>
      <btn
        class="btn-primary"
        @click="$emit('unlock')"
        v-if="!allowanceReceived && swapForm.sourceChain.label !== 'WAVES'"
      >
        Approve
      </btn>
      <btn class="btn-primary" @click="$emit('next')" v-else> Next </btn>
    </template>
  </card-swap>
</template>
